...
const TRANSLATIONS = {
  en: {
    ...
    'settings.confirm_delete': 'Are you sure you want to delete this API key?',
    ...
    'opp.title': 'Opportunity cost',
    'opp.subtitle': 'See what your down payment could grow to if you invested it at an annual return rate instead.',
    'opp.rate_label': 'Annual investment return rate (%)',
    'opp.compute': 'Calculate',
    'opp.error_rate': 'Enter an investment rate greater than 0%.',
    'opp.summary_prefix': 'If you invested',
    'opp.summary_at': 'at',
    'opp.summary_for': 'for',
    'opp.years': 'years',
    'opp.invested': 'Down payment invested',
    'opp.future_value': 'Future value',
    'opp.investment_gain': 'Investment gain',
    'opp.loan_interest': 'Loan interest paid',
    'opp.show_table': 'Show yearly growth',
    'opp.hide_table': 'Hide yearly growth',
    'opp.col_year': 'Year',
    'opp.col_value': 'Value',
    'opp.col_growth': 'Cumulative growth',
    // Heatmap panel
    ...
    'heatmap.metric_monthly': 'Monthly payment',
    'heatmap.infeasible': 'Infeasible',
    'heatmap.optimal': 'Optimal point',
    'heatmap.down_payment_axis': 'Down payment',
    ...
    // Rates reference page (C2)
    'rates.title': 'Rates reference',
    'rates.subtitle': 'Current mortgage rates and regulatory limits for all supported countries.',
    'rates.loading': 'Loading…',
    'rates.col_country': 'Country',
    'rates.col_currency': 'Currency',
    'rates.col_avg_rate': 'Avg rate',
    'rates.col_best_rate': 'Best rate',
    'rates.col_ins_avg': 'Ins. avg',
    'rates.col_ins_best': 'Ins. best',
    'rates.col_purchase_tax': 'Purchase tax',
    'rates.col_min_down': 'Min. down',
    'rates.col_max_debt': 'Max debt',
    'rates.col_max_duration': 'Max duration (mo.)',
    'rates.col_updated': 'Updated',
    'rates.refresh': 'Refresh',
    'rates.refreshing': 'Refreshing…',
    'rates.no_source': 'Manual',
    'rates.refresh_error': 'Failed',
    // Custom profile overrides (C4)
    'profile.customize': 'Customize profile',
    'profile.loading': 'Loading profile…',
    'profile.annual_rate': 'Annual interest rate (%)',
    'profile.insurance_rate': 'Insurance rate (%)',
    'profile.min_down': 'Min. down payment (%)',
    'profile.max_debt': 'Max debt ratio (%)',
    'profile.max_duration': 'Max loan duration (months)',
    'profile.reset': 'Reset to defaults',
    'profile.live_badge': 'Live',
    'profile.refresh_rate': 'Refresh live rate',
    'profile.refreshing': 'Refreshing…',
    'profile.refresh_error': 'Refresh failed',
    // Rate alerts (C5)
    'alerts.title': 'Rate alerts',
    'alerts.subtitle': 'Get notified by email when a mortgage rate drops to your target.',
    'alerts.loading': 'Loading…',
    'alerts.no_alerts': 'No rate alerts set.',
    'alerts.country': 'Country',
    'alerts.target_rate': 'Target rate (%)',
    'alerts.create': 'Add alert',
    'alerts.creating': 'Adding…',
    'alerts.delete': 'Delete',
    'alerts.confirm_delete': 'Are you sure you want to delete this alert?',
    'alerts.active': 'Active',
    'alerts.last_notified': 'Last notified',
    'alerts.never': 'Never',
    'alerts.cron_note': 'Rates are checked daily at 09:00 UTC.',
    'alerts.signin_required': 'Sign in to manage rate alerts.',
    // Navigation additions
    'nav.rates': 'Rates',
    'nav.alerts': 'Rate alerts',
    // Compare page
    ...
    'compare.no_data_cta': 'Go to my simulations',
  ...
  fr: {
    ...
    'settings.confirm_delete': 'Êtes-vous sûr de vouloir supprimer cette clé API ?',
    ...
    // Opportunity cost panel
    'opp.title': "Coût d'opportunité",
    'opp.subtitle': "Découvrez ce que votre apport pourrait rapporter si vous l'investissiez à un taux de rendement annuel.",
    'opp.rate_label': "Taux de rendement annuel de l'investissement (%)",
    'opp.compute': 'Calculer',
    'opp.error_rate': "Saisissez un taux d'investissement supérieur à 0 %.",
    'opp.summary_prefix': 'Si vous investissiez',
    'opp.summary_at': 'à',
    'opp.summary_for': 'pendant',
    'opp.years': 'ans',
    'opp.invested': 'Apport investi',
    'opp.future_value': 'Valeur future',
    'opp.investment_gain': "Gain de l'investissement",
    'opp.loan_interest': 'Intérêts du prêt payés',
    'opp.show_table': 'Afficher la croissance annuelle',
    'opp.hide_table': 'Masquer la croissance annuelle',
    'opp.col_year': 'Année',
    'opp.col_value': 'Valeur',
    'opp.col_growth': 'Croissance cumulée',
    // Heatmap panel
    ...
    'heatmap.metric_monthly': 'Mensualité',
    'heatmap.infeasible': 'Infaisable',
    'heatmap.optimal': 'Point optimal',
    'heatmap.down_payment_axis': 'Apport',
    ...
    // Rates reference page (C2)
    'rates.title': 'Référence des taux',
    'rates.subtitle': 'Taux hypothécaires et limites réglementaires actuels pour tous les pays pris en charge.',
    'rates.loading': 'Chargement…',
    'rates.col_country': 'Pays',
    'rates.col_currency': 'Devise',
    'rates.col_avg_rate': 'Taux moy.',
    'rates.col_best_rate': 'Meilleur taux',
    'rates.col_ins_avg': 'Ass. moy.',
    'rates.col_ins_best': 'Meilleure ass.',
    'rates.col_purchase_tax': 'Taxes achat',
    'rates.col_min_down': 'Apport min.',
    'rates.col_max_debt': 'Endett. max.',
    'rates.col_max_duration': 'Durée max. (mois)',
    'rates.col_updated': 'Mis à jour',
    'rates.refresh': 'Actualiser',
    'rates.refreshing': 'Actualisation…',
    'rates.no_source': 'Manuel',
    'rates.refresh_error': 'Échec',
    // Custom profile overrides (C4)
    'profile.customize': 'Personnaliser le profil',
    'profile.loading': 'Chargement du profil…',
    'profile.annual_rate': "Taux d'intérêt annuel (%)",
    'profile.insurance_rate': "Taux d'assurance (%)",
    'profile.min_down': 'Apport minimum (%)',
    'profile.max_debt': "Taux d'endettement max. (%)",
    'profile.max_duration': 'Durée max. du prêt (mois)',
    'profile.reset': 'Réinitialiser',
    'profile.live_badge': 'En direct',
    'profile.refresh_rate': 'Actualiser le taux en direct',
    'profile.refreshing': 'Actualisation…',
    'profile.refresh_error': 'Actualisation échouée',
    // Rate alerts (C5)
    'alerts.title': 'Alertes de taux',
    'alerts.subtitle': 'Recevez un e-mail quand le taux hypothécaire d\'un pays atteint votre cible.',
    'alerts.loading': 'Chargement…',
    'alerts.no_alerts': 'Aucune alerte de taux définie.',
    'alerts.country': 'Pays',
    'alerts.target_rate': 'Taux cible (%)',
    'alerts.create': 'Ajouter une alerte',
    'alerts.creating': 'Ajout…',
    'alerts.delete': 'Supprimer',
    'alerts.confirm_delete': 'Êtes-vous sûr de vouloir supprimer cette alerte ?',
    'alerts.active': 'Active',
    'alerts.last_notified': 'Dernière notification',
    'alerts.never': 'Jamais',
    'alerts.cron_note': 'Les taux sont vérifiés quotidiennement à 09:00 UTC.',
    'alerts.signin_required': 'Connectez-vous pour gérer les alertes de taux.',
    // Navigation additions
    'nav.rates': 'Taux',
    'nav.alerts': 'Alertes de taux',
    // Compare page
    ...
    'compare.no_data_cta': 'Voir mes simulations',
