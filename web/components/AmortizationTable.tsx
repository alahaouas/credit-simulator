  ...
  return (
    <div className="mt-6">
      <button
        onClick={() => setOpen(o => !o)}
        aria-expanded={open}
        aria-controls="amortization-table-content"
      ...
      {open && (
        <div id="amortization-table-content" className="mt-3 overflow-x-auto rounded-lg border dark:border-gray-700 text-sm">
