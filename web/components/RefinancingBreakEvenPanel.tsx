      ...
      {summary && (
        <>
          ...
          <button
            ...
            aria-controls="refinancing-table-content"
          ...
          {showTable && (
            <div id="refinancing-table-content" className="overflow-x-auto rounded-lg border dark:border-gray-700 text-xs max-h-80 overflow-y-auto">
