      ...
      {projection && (
        <>
          ...
          <button
            ...
            aria-controls="opportunity-cost-table-content"
          ...
          {showTable && (
            <div id="opportunity-cost-table-content" className="overflow-x-auto rounded-lg border dark:border-gray-700 text-xs max-h-80 overflow-y-auto">
