      ...
      {summary && (
        <>
          ...
          <button
            ...
            aria-controls="early-repayment-schedule"
          ...
          {showSchedule && (
            <div id="early-repayment-schedule" className="overflow-x-auto rounded-lg border dark:border-gray-700 text-xs max-h-80 overflow-y-auto">
