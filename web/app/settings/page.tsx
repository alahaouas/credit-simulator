        ...
        <div className="mb-6 rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20 p-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleCopy}
              aria-live="polite"
              className="shrink-0 rounded border dark:border-gray-600 min-w-[90px] px-3 py-1.5 text-xs hover:bg-white dark:hover:bg-gray-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
            >
