  ...
  return (
    <main className="min-h-screen p-8">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <Link href="/" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 rounded">
            {t('nav.home')}
          </Link>
        </div>
        ...
        {!accessToken && !loading ? (
          <p className="text-gray-500 dark:text-gray-400">
            ...
            <Link href="/auth" className="underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 rounded">{t('nav.signin')}</Link>
          </p>
        ) : (
          <>
            {/* Create form */}
