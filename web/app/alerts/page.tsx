      ...
      <div className="max-w-2xl mx-auto">
        ...
        {!accessToken && !loading ? (
          <p className="text-gray-500 dark:text-gray-400">
            ...
            <Link href="/auth" className="underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 dark:focus-visible:ring-gray-600 rounded">{t('nav.signin')}</Link>
          </p>
        ) : (
          <>
            {/* Create form */}
